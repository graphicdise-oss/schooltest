...
<style>
    ...
    .btn-search {
        ...
        box-shadow: 0 2px 8px rgba(84, 130, 231, 0.25);
    }
    .btn-search:hover { 
        background: #446bca; 
        transform: translateY(-1px);
        box-shadow: 0 4px 14px rgba(84, 130, 231, 0.3);
    }
    ...
    /* ตารางแบบในรูป (หัวสีฟ้า มีขอบมน และ ไม่มีเส้นคั่นสีขาวแล้ว) */
    ...
    .ls-pagination .page-item.active .
@endpush
                    ...
                    <tbody>
                        @forelse ($personnels as $index => $p)
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('leave.personnel.show', ['personnelId' => $p->personnel_id, 'fiscal_year' => $fiscalYear]) }}" class="btn-view">
