...
<div class="ls-page">
    ...
    <div class="ls-card">
        ...
        <p style="margin: 0 0 12px; color:#a15c00; font-size:0.8rem; background:#fff8e1; padding:8px 12px; border-radius:6px;">
            <i class="bi bi-info-circle"></i> แต่ละหมวด (การศึกษา/เกียรติคุณ/อบรม/ใบอนุญาต/เครื่องราชฯ) ไฟล์นี้รองรับได้ 1 รายการต่อคนเท่านั้น
            ถ้าพนักงานคนไหนมีมากกว่า 1 รายการในหมวดเดียวกัน กรุณาไปเพิ่ม/แก้ไขรายการที่เหลือผ่านหน้าประวัติบุคลากรของคนนั้นโดยตรง
        </p>
