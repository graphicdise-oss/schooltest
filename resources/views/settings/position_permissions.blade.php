...
<div class="pm-page">
    ...
    <a href="{{ route('positions.index') }}" class="pm-back">
    ...
    <div class="pm-card" style="margin-top: 20px;">
        ...
        <div class="pm-card-body">
            <div class="pm-type-name">{{ $position->name }}</div>
            <div class="pm-type-sub">เลือกเมนูที่ตำแหน่งนี้สามารถเข้าถึงได้</div>

            <form method="POST" action="{{ route('positions.savePermissions', $position->position_id) }}">
                @csrf
