...
<head>
    ...
    <style>
        ...
        * {
        ...
        .custom-section { display: flex; flex-wrap: nowrap; }
        ...
        <div class="page-inner" style="padding-top:5cm;">
            ...
            <div class="row custom-section">
                ...
                <div class="col-6 text-left" style="padding-bottom:10pt;">
                    <span class="font-size-14em spn-label">นายทะเบียน</span>
                </div>
            </div>
            ...
            <div class="row custom-section">
                <div class="col-6" style="height:23pt;"></div>
                <div class="col-6 text-left">
                    <span class="font-size-14em spn-label">ผู้รับประกาศนียบัตร</span>
                </div>
            </div>
