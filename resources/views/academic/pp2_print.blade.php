        ...
        <div class="page-inner">
            ...
            <div class="row">
                <div class="col-12 text-right" style="height:23pt;">
                    ...
                    <p style="display:inline-block; margin:-2pt 0 2pt 0; width:12%; height:20pt; vertical-align:top;">
                        <span class="font-tfarluck-data font-size-16em-data input-data"
                            style="width:100%;height:100%;padding-right:10pt;">{{ $docNum }}</span>
                    </p>
                </div>
            </div>
            ...
            <div class="row" style="margin-bottom:5pt;">
                <div class="col-12 text-center">
                    <p style="display:inline-block; margin:-3pt 6pt 2pt 0; width:62%; height:30pt; vertical-align:top;">
                        <span class="font-tfarluck-data font-size-25em-data input-data"
                            style="width:100%;height:100%;">{{ $fullName }}</span>
                    </p>
                </div>
            </div>
                ...
                <div class="col-12 text-center" style="height:26pt; padding-right:22pt;">
                    ...
                    <p style="display:inline-block; margin:-2pt 0 2pt 0; width:9%; height:25pt; vertical-align:top;">
                        <span class="font-tfarluck-data font-size-20em-data input-data"
                            style="width:100%;height:100%;">{{ $dobDay }}</span>
                    </p>
                    ...
                    <p style="display:inline-block; margin:-2pt 0 2pt 0; width:21%; height:25pt; vertical-align:top;">
                        <span class="font-tfarluck-data font-size-20em-data input-data"
                            style="width:100%;height:100%;padding-right:8pt;">{{ $dobMonth }}</span>
                    </p>
                    ...
                    <p style="display:inline-block; margin:-2pt 0 2pt 0; width:12%; height:25pt; vertical-align:top;">
                        <span class="font-tfarluck-data font-size-20em-data input-data"
                            style="width:100%;height:100%;padding-right:8pt;">{{ $dobYear }}</span>
                    </p>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-12 text-center" style="height:26pt; padding-right:22pt;">
                    ...
                    <p style="display:inline-block; margin:-2pt 0 2pt 0; width:9%; height:25pt; vertical-align:top;">
                        <span class="font-tfarluck-data font-size-20em-data input-data"
                            style="width:100%;height:100%;">{{ $issDay }}</span>
                    </p>
                    <span class="font-tfarluck font-size-24em spn-label">เดือน</span>
                    <p style="display:inline-block; margin:-2pt 0 2pt 0; width:21%; height:25pt; vertical-align:top;">
                        <span class="font-tfarluck-data font-size-20em-data input-data"
                            style="width:100%;height:100%;padding-right:8pt;">{{ $issMonth }}</span>
                    </p>
                    <span class="font-tfarluck font-size-24em spn-label">พ.ศ.</span>
                    <p style="display:inline-block; margin:-2pt 0 2pt 0; width:12%; height:25pt; vertical-align:top;">
                        <span class="font-tfarluck-data font-size-20em-data input-data"
                            style="width:100%;height:100%;padding-right:8pt;">{{ $issYear }}</span>
                    </p>
                </div>
            </div>
        ...
        <div class="page-inner" style="padding-top:5cm;">
            ...
            <div class="row custom-section">
                <div class="col-6 text-left" style="height:23pt; justify-content:flex-start;">
                    <p
                        style="display:inline-block; margin:-6pt -2pt 2pt 44pt; width:53%; height:17pt; vertical-align:top;">
                        <span class="font-tfarluck-data font-size-14em-data input-data"
                ...
                <div class="col-6 text-left">
                    <p
                        style="display:inline-block; margin:-6pt -2pt 2pt 0; width:53%; height:17pt; vertical-align:top;">
                        <span class="font-tfarluck-data font-size-14em-data input-data"
                            style="width:100%;height:100%;text-align:center;"></span>
                    </p>
                </div>
            ...
            <div class="row custom-section">
                ...
                <div class="col-6 text-left">
                    ...
                    <p
                        ...
                        <span class="font-tfarluck-data font-size-14em-data input-data"
                            style="width:100%;height:100%;padding-left:8pt;">{{ $issYear }}</span>
                    </p>
                </div>
            </div>
        </div>
