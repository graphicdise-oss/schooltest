...
@section('content')
<div class="ac-page">
    <nav class="ac-breadcrumb"><a href="#">เอกสาร ปพ./รบ.</a><i class="bi bi-chevron-right"></i><span>แบบบันทึกผลการพัฒนาคุณภาพผู้เรียน (ปพ.5)</span></nav>

    <div class="ac-card">
        <div class="ac-card-header"><i class="bi bi-journal-text"></i> เลือกวิชาเพื่อจัดทำ ปพ.5</div>
        <div class="ac-card-body">
            <form method="GET" action="{{ route('por5.index') }}" style="display:grid;grid-template-columns:1fr 1fr 1fr auto;gap:12px;align-items:flex-end;max-width:900px;margin-bottom:20px">
            ...
            <div class="ac-table-wrap">
                <table class="ac-table">
                    <thead><tr><th>#</th><th>รหัสวิชา</th><th>ชื่อวิชา</th><th>ห้อง</th><th>ครูผู้สอน</th><th colspan="2">จัดการ</th></tr></thead>
                    <tbody>
