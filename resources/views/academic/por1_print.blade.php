        ...
        <table style="width: 100%; table-layout: fixed; border-collapse: collapse; font-size: 12px; border: 0.5px solid #000;">
            ...
            <tbody>
                <tr style="font-weight: bold;">
                    <td colspan="3" style="text-align: left; padding: 2px 6px; border-right: 0.5px solid #000; border-bottom: 0.5px solid #000;">ปีการศึกษา ...... มัธยมศึกษาปีที่ 4<br>ภาคเรียนที่ 1</td>
                    <td colspan="3" style="text-align: left; padding: 2px 6px; border-right: 0.5px solid #000; border-bottom: 0.5px solid #000;">ปีการศึกษา ...... มัธยมศึกษาปีที่ 5<br>ภาคเรียนที่ 1</td>
                    <td colspan="3" style="text-align: left; padding: 2px 6px; border-bottom: 0.5px solid #000;">ปีการศึกษา ...... มัธยมศึกษาปีที่ 6<br>ภาคเรียนที่ 1</td>
                </tr>
                @foreach(['แนะแนว','ชุมนุม','กิจกรรมเพื่อสังคมและสาธารณประโยชน์'] as $act)
                <tr>
                    <td style="padding: 2px 6px; text-align: left; border-right: 0.5px solid #000; border-bottom: 0.5px solid #000;">{{ $act }}</td>
                    <td style="text-align: center; border-right: 0.5px solid #000; border-bottom: 0.5px solid #000;"></td>
                    <td style="text-align: center; border-right: 0.5px solid #000; border-bottom: 0.5px solid #000;"></td>
                    <td style="padding: 2px 6px; text-align: left; border-right: 0.5px solid #000; border-bottom: 0.5px solid #000;">{{ $act }}</td>
                    <td style="text-align: center; border-right: 0.5px solid #000; border-bottom: 0.5px solid #000;"></td>
                    <td style="text-align: center; border-right: 0.5px solid #000; border-bottom: 0.5px solid #000;"></td>
                    <td style="padding: 2px 6px; text-align: left; border-right: 0.5px solid #000; border-bottom: 0.5px solid #000;">{{ $act }}</td>
                    <td style="text-align: center; border-right: 0.5px solid #000; border-bottom: 0.5px solid #000;"></td>
                    <td style="text-align: center; border-bottom: 0.5px solid #000;"></td>
                </tr>
                @endforeach

                <tr style="font-weight: bold;">
                    <td colspan="3" style="text-align: left; padding: 2px 6px; border-right: 0.5px solid #000; border-bottom: 0.5px solid #000;">ภาคเรียนที่ 2</td>
                    <td colspan="3" style="text-align: left; padding: 2px 6px; border-right: 0.5px solid #000; border-bottom: 0.5px solid #000;">ภาคเรียนที่ 2</td>
                    <td colspan="3" style="text-align: left; padding: 2px 6px; border-bottom: 0.5px solid #000;">ภาคเรียนที่ 2</td>
                </tr>
                @foreach(['แนะแนว','ชุมนุม','กิจกรรมเพื่อสังคมและสาธารณประโยชน์'] as $act)
                <tr>
                    <td style="padding: 2px 6px; text-align: left; border-right: 0.5px solid #000; border-bottom: 0.5px solid #000;">{{ $act }}</td>
                ...
                <tr>
                    <td style="border-right: 0.5px solid #000; padding: 4px;">&nbsp;</td>
                    ...
                    <td colspan="2" style="vertical-align: top; padding: 0; border-right: 0.5px solid #000;">
                        <table style="width: 100%; table-layout: fixed; border-collapse: collapse;">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <th style="border-right: 0.5px solid #000; border-bottom: 0.5px solid #000; padding: 6px; text-align: center; font-weight: normal;">สรุปผลการประเมิน</th>
                                    <th style="border-bottom: 0.5px solid #000; padding: 6px; text-align: center; font-weight: normal;">ผลการตัดสิน</th>
                                </tr>
                                {{-- ข้อมูลคะแนน --}}
                                <tr>
                                    <td style="border-right: 0.5px solid #000; padding: 8px 10px; vertical-align: top; line-height: 1.8;">
                                ...
                                {{-- วันที่จบ --}}
                                <tr>
                                    <td colspan="2" style="border-top: 0.5px solid #000; border-bottom: 0.5px solid #000; padding: 6px 10px; line-height: 1.8;">
                                ...
                                {{-- ผลการทดสอบระดับชาติ --}}
                                <tr>
                                    <th colspan="2" style="border-bottom: 0.5px solid #000; padding: 6px; text-align: center; font-weight: normal;">ผลการทดสอบระดับชาติ</th>
                                </tr>
                                <tr>
                                ...
                                {{-- สัดส่วนผลการเรียน... --}}
                                <tr>
                                    <th colspan="2" style="border-top: 0.5px solid #000; border-bottom: 0.5px solid #000; padding: 6px; text-align: center; font-weight: normal;">สัดส่วนผลการเรียนและผลการทดสอบระดับชาติ</th>
                                </tr>
                                <tr>
                                ...
                                {{-- เกณฑ์การประเมิน... --}}
                                <tr>
                                    <th colspan="2" style="border-top: 0.5px solid #000; border-bottom: 0.5px solid #000; padding: 6px; text-align: center; font-weight: normal;">เกณฑ์การประเมินของสถานศึกษา</th>
                                </tr>
                                <tr>
                    ...
                    <td colspan="1" style="vertical-align: top; padding: 0;">
                        <table style="width: 100%; table-layout: fixed; border-collapse: collapse; height: 100%;">
                            ...
                            <tbody>
                                {{-- หัวข้อ กลุ่มสาระ --}}
                                <tr>
                                    <th style="border-right: 0.5px solid #000; border-bottom: 0.5px solid #000; padding: 4px; text-align: center; font-weight: normal;">กลุ่มสาระการเรียนรู้/<br>การศึกษาค้นคว้าด้วยตนเอง</th>
                                    <th style="border-right: 0.5px solid #000; border-bottom: 0.5px solid #000; padding: 4px; font-weight: normal;"><div class="vert-header" style="height: 60px;">หน่วยกิตรวม</div></th>
                                    <th style="border-bottom: 0.5px solid #000; padding: 4px; font-weight: normal;"><div class="vert-header" style="height: 60px;">ผลการเรียนเฉลี่ย</div></th>
                                </tr>
                                {{-- รายวิชา --}}
                                ...
                                <tr>
                                    <td style="border-right: 0.5px solid #000; border-bottom: 0.5px solid #000; padding: 3px 6px;">{{ $group }}</td>
                                    <td style="border-right: 0.5px solid #000; border-bottom: 0.5px solid #000; text-align: center;"></td>
                                    <td style="border-bottom: 0.5px solid #000; text-align: center;"></td>
                                </tr>
                                @endforeach
                                {{-- ผลการเรียนเฉลี่ยตลอดหลักสูตร --}}
                                <tr>
                                    <td style="border-right: 0.5px solid #000; border-bottom: 0.5px solid #000; padding: 5px 6px;">ผลการเรียนเฉลี่ยตลอดหลักสูตร</td>
                                    <td style="border-right: 0.5px solid #000; border-bottom: 0.5px solid #000; text-align: center;">{{ $totalCredits ?? '89.0' }}</td>
                                    <td style="border-bottom: 0.5px solid #000; text-align: center;">{{ $gpa ?? '3.58' }}</td>
                                </tr>
