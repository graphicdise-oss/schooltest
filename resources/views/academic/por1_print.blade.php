...
<div class="page">
    <div class="subpage" style="height: 100%; display: flex; flex-direction: column;">
        ...
        <table style="width: 100%; table-layout: fixed; border-collapse: collapse; font-size: 12px; border: 1px solid #000;">
            ...
            <thead>
                <tr>
                    <th style="border-right: 1px solid #000; border-bottom: 1px solid #000; padding: 4px; text-align: center; font-weight: bold; font-size: 13px;">กิจกรรม</th>
                    <th style="border-right: 1px solid #000; border-bottom: 1px solid #000; padding: 4px; font-weight: bold; font-size: 13px;"><div class="vert-header" style="height: 50px;">เวลา<br>(ชั่วโมง)</div></th>
                    <th style="border-right: 1px solid #000; border-bottom: 1px solid #000; padding: 4px; font-weight: bold; font-size: 13px;"><div class="vert-header" style="height: 50px;">ผลการ<br>ประเมิน</div></th>
                    <th style="border-right: 1px solid #000; border-bottom: 1px solid #000; padding: 4px; text-align: center; font-weight: bold; font-size: 13px;">กิจกรรม</th>
                    <th style="border-right: 1px solid #000; border-bottom: 1px solid #000; padding: 4px; font-weight: bold; font-size: 13px;"><div class="vert-header" style="height: 50px;">เวลา<br>(ชั่วโมง)</div></th>
                    <th style="border-right: 1px solid #000; border-bottom: 1px solid #000; padding: 4px; font-weight: bold; font-size: 13px;"><div class="vert-header" style="height: 50px;">ผลการ<br>ประเมิน</div></th>
                    <th style="border-right: 1px solid #000; border-bottom: 1px solid #000; padding: 4px; text-align: center; font-weight: bold; font-size: 13px;">กิจกรรม</th>
                    <th style="border-right: 1px solid #000; border-bottom: 1px solid #000; padding: 4px; font-weight: bold; font-size: 13px;"><div class="vert-header" style="height: 50px;">เวลา<br>(ชั่วโมง)</div></th>
                    <th style="border-bottom: 1px solid #000; padding: 4px; font-weight: bold; font-size: 13px;"><div class="vert-header" style="height: 50px;">ผลการ<br>ประเมิน</div></th>
                </tr>
            </thead>
            <tbody>
