        ...
        <form method="POST" action="{{ route('grades.importBulkUpload') }}"
            ...
            <div class="gib-modal-body">
                <p style="font-size:0.8rem; color:#777; margin:0 0 4px">
                    ใช้ไฟล์ที่ดาวน์โหลดจากปุ่ม "ดาวน์โหลดแบบฟอร์มทั้งห้อง" แล้วกรอกข้อมูล — ไฟล์นี้มีชีต (แท็บ) แยกให้คนละคน
                    ชีตละแบบฟอร์มเดียวกับที่ใช้นำเข้าทีละคน มีแถว "ชื่อ-สกุล"/"รหัสนักศึกษา" บอกไว้ว่าชีตนั้นเป็นของใคร
                    จึงใส่ข้อมูลของใครก็ได้ในไฟล์เดียวกัน ไม่จำเป็นต้องเป็นห้องที่เลือกไว้ด้านบน (เพิ่ม/ลบชีตเองได้ตามต้องการ)
                </p>
                <div>
