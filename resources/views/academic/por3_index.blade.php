        ...
        <form method="GET" action="{{ route('por3.index') }}" id="searchForm">
            ...
            <div class="p3-search-row2">
                ...
                <div class="p3-field" style="display:flex;gap:8px;flex-wrap:wrap;">
                    ...
                    <a href="{{ route('settings.school.index') }}" class="btn-search" style="background:#1565c0;white-space:nowrap;text-decoration:none;display:inline-flex;align-items:center;">
