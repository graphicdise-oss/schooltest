    ...
    <div class="att-xl-modal">
        ...
        <div class="att-xl-modal-body">
            ...
            <p style="font-size:.78rem;color:#999;margin:0">
                คอลัมน์วันที่มีครบทุกวันของเดือน — วันเสาร์-อาทิตย์และวันหยุดตามปฏิทิน (ตั้งค่าไว้ที่เมนูวันหยุด) จะแรเงาหัวตารางให้สังเกตง่าย
                แต่ละช่องมีลิสต์ให้เลือก ({{ implode(' / ', \App\Models\Academic\ClassAttendance::STATUSES) }}) เว้นว่างไว้ได้ถ้าวันนั้นไม่เช็คชื่อ
            </p>
        </div>
