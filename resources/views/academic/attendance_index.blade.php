...
<div class="ac-page">
    ...
    <div class="ac-card">
        <div class="ac-card-header"><i class="bi bi-clipboard-check"></i> เลือกวิชาเพื่อเช็คชื่อ</div>
                ...
                <table class="ac-table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><a href="{{ route('attendance.mark', $a->assign_id) }}" class="ac-btn ac-btn-primary ac-btn-sm"><i class="bi bi-check2-square"></i> เช็คชื่อ</a></td>
                        </tr>
                        @empty
