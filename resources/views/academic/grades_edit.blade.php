        ...
        <form method="POST" action="{{ route('grades.importTranscript', $student->student_id) }}"
            ...
            <div class="ge-modal-body">
                <p style="font-size:0.8rem; color:#777; margin:0 0 4px">
                    ...
                    (สูงสุด 3 ปีการศึกษา/ระดับชั้น เคียงกัน แต่ละคนกรอกจำนวนวิชาไม่เท่ากันได้ ไม่ต้องกรอกให้ครบทุกแถว
                    และมีตารางกิจกรรมพัฒนาผู้เรียนแยกต่างหากด้านล่างด้วย) — เกรดที่นำเข้าจะไม่ผูกกับห้องเรียนจริง
                </p>
                <div>
