...
<head>
    ...
    <style>
        ...
        /* ===== Mobile safety net =====
           หน้าเนื้อหาแต่ละหน้ามี CSS เฉพาะของตัวเองเยอะมาก (ตาราง กริด โมดัล ฯลฯ) ไม่ได้ทำ responsive
           ไว้ทีละหน้า กฎด้านล่างนี้เป็นตาข่ายรองรับกลางที่โหลดในทุกหน้าที่ใช้ layout นี้ (มาทีหลังสไตล์ชีต
           เฉพาะหน้าในเอกสาร จึงชนะ CSS เฉพาะหน้าที่ specificity เท่ากัน) ทำให้อย่างน้อย "ใช้งานได้" บนจอมือถือ
           ทุกหน้าโดยไม่ต้องไปไล่แก้ทีละไฟล์ */
